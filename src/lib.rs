...
//!   `a1op`, `a1lx`, `iscl`, `rref`, `crtt`, `mdft`, `udes`. Derived-image
//!   carriers: `iovl` / `iden` /
...
pub use meta::{
    A1lx, A1op, AuxC, AuxKind, Cclv, Clap, Clli, Colr, Crtt, Imir, IrefEntry, Irot, Iscl, Ispe,
    ItemInfo, ItemLocation, Lsel, Mdcv, Mdft, Meta, Pasp, Pixi, Property, Rloc, Rref, Udes,
    AUX_URN_ALPHA_HEVC, AUX_URN_ALPHA_MPEG, AUX_URN_DEPTH_HEVC, AUX_URN_DEPTH_MPEG,
